...
// combine all of spherical Bessel/Hankel functions
// p = 1 -> jn, 2 -> yn, 3 -> h1n, 4 -> h2n
std::complex<double> spherical_bessel_zn(int p, int n, std::complex<double> z, bool derivative=false);
...
std::complex<double> riccati_bessel_zn(int p, int n, std::complex<double> z, bool derivative=false);
